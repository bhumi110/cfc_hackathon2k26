...
import { FaGithub, FaInstagram, FaLinkedin, FaDiscord, FaEnvelope } from 'react-icons/fa';
import '../styles/footer.css';

const socialLinks = [
    { icon: FaGithub, href: 'https://github.com/CodeNEST-NSHM', label: 'GitHub' },
    { icon: FaInstagram, href: 'https://www.instagram.com/codenest_osdc?igsh=bm93ZXJwMDJ5ZjJu', label: 'Instagram' },
    { icon: FaLinkedin, href: 'https://www.linkedin.com/company/codenest-osdc/', label: 'LinkedIn' },
...
export default function Footer() {
    ...
    return (
        <footer className="footer-section" ref={ref}>
            ...
            >
                {/* Brand */}
                <motion.div className="footer-col footer-brand" variants={colVariant(0)}>
                    <h3 className="footer-logo">Hackathon</h3>
